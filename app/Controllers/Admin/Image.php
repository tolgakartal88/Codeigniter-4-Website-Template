...
class Image extends BaseController
{
	...
	public function __construct(){
		$this->rootPath =  ROOTPATH."public/uploads/images";
		$this->rootUrl = base_url("public/uploads/images/");
	}
	...
	{ 
		...
		//scandir($this->rootPath));
		  //var_dump($explorerList);
		asort($explorerList);
		$this->data["page"]["explorer_list"] = $explorerList;

        return view('admin/images.php', $this->data);
	}
	...
	public function Add($value='')
    {
        ...
        foreach ($postFiles as $key => $value) {
            ...
            $file->move(ROOTPATH."public/uploads/images/".$postData["folder_path"]."/",$value["name"]);
        }
    }
