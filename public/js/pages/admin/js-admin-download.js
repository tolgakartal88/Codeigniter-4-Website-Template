	...
	xhr.onreadystatechange=(e)=>{
		if (xhr.readyState != 4) { return }
			if (xhr.status !=200) {
				...
				objectSelectValues.push({id:"_programlar_",title:"_programlar_"});	
				objectSelectValues.push({id:"_eklentiler_",title:"_eklentiler_"});	
				...
				var taskModals2 = new TaskModals("download","admin"); 
